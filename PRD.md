...
### Infrastructure
- **Backend**: FastAPI under uvicorn on AWS App Runner (see [ADR 001](docs/adr/001-uvicorn-not-mangum.md)). Docker image includes ffmpeg via `apt-get`. 1 vCPU / 2GB RAM starting configuration, auto-scaling enabled.
